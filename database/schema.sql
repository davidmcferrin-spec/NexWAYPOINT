...
CREATE TABLE users (
    ...
    photo_focus_x   DECIMAL(5,2) NOT NULL DEFAULT 50.00,
    photo_focus_y   DECIMAL(5,2) NOT NULL DEFAULT 50.00,
...
-- airports: IATA → city/state label + IANA timezone for wall-clock times.
